    ...
    render() {
        ...
        return (
            <div style={containerStyle} >
                ...
                <ul style={listStyle} >
                    <li style={liHomeStyle} onMouseOver={changeBackgroundOn} onMouseLeave={changeBackgroundOut}><a  href="https://lol.sg" style={lilinkStyle}><span style={spanHomeStyle} onMouseOver={emptyEvent} onMouseLeave={emptyEvent}>Home</span></a></li>
                    <li style={liAnalysisStyle}><a id='home' href="https://lol.sg/tierList" style={lilinkChampStyle} onMouseOver={changeBackgroundOn} onMouseLeave={changeBackgroundOut}><span style={spanOtherStyle} onMouseOver={emptyEvent} onMouseLeave={emptyEvent}>Champion Analysis</span></a></li>
